...
public class RSAEncrypt
{
    ...
    /** 
     * 从文件中输入流中加载公钥,读取出来的是公钥字符串 ,即Base64.encode(publicKey.getEncoded())字符串
     *  
     * @param in 
     *            公钥输入流 
     * @throws Exception 
    ...
    /** 
     * 从字符串中加载公钥 ,通过Base64.encode(publicKey.getEncoded())字符串得到公钥
     *  
     * @param publicKeyStr 
     *            公钥数据字符串 
     * @throws Exception 
    ...
    public static RSAPublicKey loadPublicKeyByStr(String publicKeyStr) throws Exception
    {
        try
        {
            byte[] buffer = Base64.decode(publicKeyStr);//先decode
