...
public class T01Asm extends ClassLoader implements Opcodes {

    public static void main(final String args[]) throws Exception {
        //定义一个叫做 Example的类, ClassWriter类是ASM中的核心API,用于生成一个类的字节码
